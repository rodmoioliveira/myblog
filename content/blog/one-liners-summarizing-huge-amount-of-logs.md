+++
title = "One-Liners: Summarizing huge amount of logs"
description = "?"
date = 2021-11-27
slug = "one-liners-summarizing-huge-amount-of-logs"
draft = false
+++
...
bat access.log -r 1:100000 | \
   sd '(.+)(GET|POST|PUT|PATCH|OPTION|HEAD)(.+)' '$2' | \
   sort | \
   uniq -c | \
   sort -n
...
subset range of the data, from 30,000 to 40,000:
